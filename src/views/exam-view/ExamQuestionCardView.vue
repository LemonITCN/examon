<template>
  <div class="exam-question-card-view-impl">
    ...
    <exam-answer-options-view class="exam-answer-view" :question="question"></exam-answer-options-view>
  </div>
</template>
...
@Component({
  components: {ExamAnswerOptionsView, ExamTitleView}
})
